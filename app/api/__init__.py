...
from app.devices.hardware_router import router as edge_router
...
api_router.include_router(device_router, prefix="/devices/client", tags=["Devices"])
api_router.include_router(edge_router, prefix="/devices/edge", tags=["Devices"])
